...
This project is licensed under the [GNU General Public License version 3 (GPLv3)](LICENSE.md). See the [LICENSE](https://github.com/kochas23/Threat-Watch/blob/Core/LICENSE) file for details.
