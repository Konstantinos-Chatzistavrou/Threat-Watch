...
Αυτή η άδεια σας παρέχει την ελευθερία να χρησιμοποιήσετε, τροποποιήσετε και να διανείμετε αυτό το λογισμικό σύμφωνα με τους όρους που περιγράφονται στην ΓΔΑ έκδοση 3. Είναι σημαντικό να εξετάσετε το πλήρης κείμενο της άδειας [LICENSE](https://github.com/kochas23/Threat-Watch/blob/Core/LICENSE) για να κατανοήσετε τα δικαιώματα και τις υποχρεώσεις σας.
